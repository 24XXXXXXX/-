...
public class ConsultationDetailResponse {
    ...
    private List<ConsultationMessageItem> messages;
    ...
    public List<ConsultationMessageItem> getMessages() {
        return messages;
    }

    public void setMessages(List<ConsultationMessageItem> messages) {
